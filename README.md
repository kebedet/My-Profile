...
•	Data Modeling: Star Schema, Snowflake Schema, ER Modeling
•	Integration & Automation: Power Automate, JSON, XML
...
•	Built KPI and OKR dashboards for executives.
•	Optimized for mobile and accessibility.
•	Demo: [Power BI Service Link]
3. SQL Collation Troubleshooting
•	Resolved collation conflicts in multilingual datasets.
•	Documented best practices for accent sensitivity.
•	Demo: [Case Study PDF]
________________________________________
📊 Case Studies
